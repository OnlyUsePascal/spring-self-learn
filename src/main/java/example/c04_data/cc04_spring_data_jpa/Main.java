...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        ApplicationContext context = new AnnotationConfigApplicationContext(AppContextConfigJpa.class);
        StudentService studentService = context.getBean(StudentService.class);
        // studentService.execBasic();
        studentService.execTransaction();

        // context = new AnnotationConfigApplicationContext(AppContextConfigHibernate.class);
        // example.hibernate_style.StudentService studentService2 =
        //         context.getBean(example.hibernate_style.StudentService.class);
